...
- [[*Dotfiles][Dotfiles]]: Configuration files for various tools (bash, i3, etc.)
- [[*Scripts][Scripts]]: Utility scripts in the =bin/= directory
- [[*ECA Skills][ECA Skills]]: Specialized skills for the Editor Code Assistant
...
* Scripts
The [[file:bin/][bin/]] directory contains various utility scripts for development,
git workflow management, and system tasks. See the [[file:bin/README.org][bin/README]] for
more details on individual scripts.

* ECA Skills
This repository now includes skills for the Editor Code Assistant
(ECA). These are located in [[file:dotconfig/eca/skills/][dotconfig/eca/skills/]].

- [[file:dotconfig/eca/skills/git-query/SKILL.md][Git Query]]: Efficiently query and summarize git history.
